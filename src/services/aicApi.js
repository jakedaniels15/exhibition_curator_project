  ...
  try {
    ...
    const response = await fetch(
      `${AIC_BASE_URL}/artworks/search?q=${encodeURIComponent(
        query
      )}&limit=${limit}&fields=id,title,artist_display,date_display,medium_display,image_id,thumbnail,place_of_origin,department_title,artwork_type_title,gallery_title`
    );
